...
@section('content')
    <div class="row gx-5 gyaru-home">
        ...
        <div class="col-4">
            ...
            <div class="row align-items-center mb-5 profile-summary">
                <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <a href="#" class="text-decoration-none text-dark fw-bold" data-bs-toggle="modal"
                                data-bs-target="#suggestions-modal">See all</a>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-auto">
                                <form action="{{ route('follow.store', $user->id) }}" method="post">
                                    @csrf
                                    <button type="submit" class="btn follow-btn btn-sm">Follow</button>
                                </form>
                            </div>
                        </div>
                    @endforeach
